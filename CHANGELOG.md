...
- **Pagination**: Add reusable multi-column sorting query models (`SortParams`, `PageSortParams`), parsed `sort_pairs`, and `paginate_query(..., sort_columns=...)` support with explicit field whitelists.
